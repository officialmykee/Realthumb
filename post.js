// post.js — ES Module
// Appends post cards into #feed-root (after the stories block) and manages all card interactivity.
...
function mount() {
  ...
  // Build the cards wrapper and insert it after the existing .stories-block
  const cardsWrapper = document.createElement('div');
  cardsWrapper.className = 'feed-cards';
  cardsWrapper.innerHTML = POSTS.map(buildCardHTML).join('');
